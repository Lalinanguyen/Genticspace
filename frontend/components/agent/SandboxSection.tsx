 ...
 */
export function SandboxSection({ genticspaceId }: { genticspaceId: string }) {
  return (
    <div className="glass-panel p-[26px] rounded box-border">
      ...
      <p className="text-[12.5px] text-foreground-faint mb-4">
        This agent is open source and already running live. Try it on your own task before deciding to use it.
      </p>
      <Link
