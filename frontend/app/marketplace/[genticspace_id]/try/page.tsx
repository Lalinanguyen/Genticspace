...
import { getAgent, listAgents, ApiError } from "@/lib/api";
...
export default async function RunConsolePage({
  ...
  // The run console only makes sense for agents with something live to try —
  // today that's open-source HuggingFace Spaces (see
  // app/services/agent_queries.py's compute_sandbox_fields). Anything else
  // gets sent back to its own profile page rather than a broken/empty console.
